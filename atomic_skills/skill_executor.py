...
class SkillExecutor:
    ...
    def _execute_rule(self, skill_id: str, *, args: dict[str, Any], graph: dict[str, Any] | None) -> Any:
        ...
        rule_fns = {
            ...
            "commit_answer": lambda: reasoning.commit_answer(
                args.get("verified_claim", {}),
                options=args.get("options"),
                answer_format=args.get("answer_format", "free_text"),
                support_chain=args.get("support_chain", {"evidence_refs": []}),
                decision_policy=args.get("decision_policy"),
            ),
