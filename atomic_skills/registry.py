...
REASONING_GRAPH_ASSEMBLY_SKILLS = [
    ...
    SkillSpec("verify_claim_support", "reasoning_graph_assembly", "Verify that an evidence chain supports a claim.", ["claim", "evidence_chain", "support_policy"], ["verification_score", "passed", "failure_code", "messages"], "evidence entails or supports claim", ["insufficient_evidence"], reasoning.verify_claim_support),
