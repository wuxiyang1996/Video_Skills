#!/usr/bin/env bash
# GPT-OSS 120B baseline on Tetris (8 episodes) via OpenRouter
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/output/gptoss120b_tetris_${TIMESTAMP}}"
mkdir -p "${OUTPUT_DIR}"

echo "══════════════════════════════════════════════════════════════"
echo "  GPT-OSS 120B Baseline — Tetris (${EPISODES} episodes)"
echo "══════════════════════════════════════════════════════════════"
echo "  Model:     ${MODEL}"
...
echo ""
echo "  GPT-OSS 120B Tetris Baseline COMPLETE — ${OUTPUT_DIR}"
