#!/usr/bin/env bash
# Gemini 3.1 Pro baseline on Super Mario (8 episodes) via OpenRouter
#
...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/output/gemini31pro_super_mario_${TIMESTAMP}}"
mkdir -p "${OUTPUT_DIR}"

echo "══════════════════════════════════════════════════════════════"
echo "  Gemini 3.1 Pro Baseline — Super Mario (${EPISODES} episodes)"
echo "══════════════════════════════════════════════════════════════"
echo "  Model:     ${MODEL}"
...
echo ""
echo "  Gemini 3.1 Pro Super Mario Baseline COMPLETE — ${OUTPUT_DIR}"
