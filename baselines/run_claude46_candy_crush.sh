#!/usr/bin/env bash
# Claude Sonnet 4.6 baseline on Candy Crush (8 episodes) via OpenRouter
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/output/claude46_candy_crush_${TIMESTAMP}}"
mkdir -p "${OUTPUT_DIR}"

echo "══════════════════════════════════════════════════════════════"
echo "  Claude Sonnet 4.6 Baseline — Candy Crush (${EPISODES} episodes)"
echo "══════════════════════════════════════════════════════════════"
echo "  Model:     ${MODEL}"
...
echo ""
echo "  Claude Sonnet 4.6 Candy Crush Baseline COMPLETE — ${OUTPUT_DIR}"
