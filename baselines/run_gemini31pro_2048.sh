#!/usr/bin/env bash
# Gemini 3.1 Pro baseline on 2048 (8 episodes) via OpenRouter
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/output/gemini31pro_2048_${TIMESTAMP}}"
mkdir -p "${OUTPUT_DIR}"

echo "══════════════════════════════════════════════════════════════"
echo "  Gemini 3.1 Pro Baseline — 2048 (${EPISODES} episodes)"
echo "══════════════════════════════════════════════════════════════"
echo "  Model:     ${MODEL}"
...
echo ""
echo "  Gemini 3.1 Pro 2048 Baseline COMPLETE — ${OUTPUT_DIR}"
