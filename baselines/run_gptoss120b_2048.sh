#!/usr/bin/env bash
# GPT-OSS 120B baseline on 2048 (8 episodes) via OpenRouter
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/output/gptoss120b_2048_${TIMESTAMP}}"
mkdir -p "${OUTPUT_DIR}"

echo "══════════════════════════════════════════════════════════════"
echo "  GPT-OSS 120B Baseline — 2048 (${EPISODES} episodes)"
echo "══════════════════════════════════════════════════════════════"
echo "  Model:     ${MODEL}"
...
echo ""
echo "  GPT-OSS 120B 2048 Baseline COMPLETE — ${OUTPUT_DIR}"
