...
# using the skill_agents pipeline.
#
# Reads from:  labeling/output/gpt54/<game>/episode_*.json
# Writes to:   skill_agents/extract_skillbank/output/gpt54_skillbank_grpo/<game>/
#
...
#
# Usage:
#   bash skill_agents/extract_skillbank/run_extract_skillbank_grpo.sh                    # all games
#   bash skill_agents/extract_skillbank/run_extract_skillbank_grpo.sh --games tetris     # specific game
#   bash skill_agents/extract_skillbank/run_extract_skillbank_grpo.sh --one_per_game -v  # quick test
#   bash skill_agents/extract_skillbank/run_extract_skillbank_grpo.sh --dry_run          # preview only
#
set -euo pipefail
...
echo "=============================================================="
echo "  Skill Bank Extraction Pipeline (skill_agents)"
echo "=============================================================="
echo "  Pipeline: skill_agents"
