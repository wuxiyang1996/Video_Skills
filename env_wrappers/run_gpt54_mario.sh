...
# launches test_orak_mario_gpt54.py with --game super_mario.
#
# Usage:
#   bash env_wrappers/run_gpt54_mario.sh                     # 3 episodes, defaults
#   bash env_wrappers/run_gpt54_mario.sh --episodes 10       # override episodes
#   bash env_wrappers/run_gpt54_mario.sh --max_steps 200     # override max steps
#
...
python "${SCRIPT_DIR}/test_orak_mario_gpt54.py" \
    --game super_mario \
    "$@"
