...
#   python env_wrappers/run_orak_benchmark.py --game super_mario --episodes 1
...
echo ""
echo "  Quick test:"
echo "    python -c \"from env_wrappers.orak_nl_wrapper import make_orak_env; e=make_orak_env('super_mario'); print(e.reset()[0][:200]); e.close()\""
