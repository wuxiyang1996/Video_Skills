...
```bash
python -m motif.mine_existing_l1_l2 \
  ...
  --output-bank motif/output/batch3_strict_qwen_motif_bank.jsonl \
  --summary-output motif/output/batch3_strict_qwen_motif_summary.json \
  --min-support 2
```
...
Generated smoke outputs are written under `motif/output/`.
