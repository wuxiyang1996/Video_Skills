...
from skill_agents_grpo.bank_maintenance.local_redecode import (
    build_redecode_requests,
    collect_affected_trajectories,
    redecode_windows,
    relabel_via_alias,
)
from skill_agents_grpo.bank_maintenance.merge import (
    MergeResult,
    execute_merge,
    retrieve_merge_candidates,
    verify_merge_pair,
)
from skill_agents_grpo.bank_maintenance.refine import (
    RefineResult,
...
from skill_agents_grpo.bank_maintenance.split import (
    SplitResult,
...
def run_bank_maintenance(
    ...
    for skill_id, prof in list(profiles.items()):
        ...
        if rr.new_contract is not None:
            ...
            from skill_agents_grpo.stage3_mvp.contract_verify import (
