...
| sft_mix (VH + VRBench-480 + CG-train, 4,520 rows) | 47.3 | **51.3** (+2.9 [+0.7, +5.1] vs 235B) | VRBench held-out 495: **75.4** vs 235B 71.7, +3.6 [+0.2, +7.3]; CG 237: 39.4 vs 235B 41.1 (n.s.) | +9.3 [+3.0, +15.3] |
